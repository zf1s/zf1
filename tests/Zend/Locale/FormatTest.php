...
class Zend_Locale_FormatTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testIsFloat()
    {
        ...
        $this->assertFalse(Zend_Locale_Format::isFloat(null, ['locale' => 'de_AT']));
        $this->assertFalse(Zend_Locale_Format::isFloat(',', ['locale' => 'de_AT']));
        $this->assertTrue(Zend_Locale_Format::isFloat('1e20', ['locale' => 'de_AT']));
        $this->assertTrue(Zend_Locale_Format::isFloat('1e-20', ['locale' => 'de_AT']));
        $this->assertFalse(Zend_Locale_Format::isFloat('1-e20', ['locale' => 'de_AT']));
        $this->assertFalse(Zend_Locale_Format::isFloat('1-20', ['locale' => 'de_AT']));
    ...
    public function testgetTime()
    {
        ...
        $this->assertTrue(is_array(Zend_Locale_Format::getTime('13:14:55', ['date_format' => 'HH:mm:ss'])));
        $options = ['date_format' => 'h:mm:ss a', 'locale' => 'en'];
        ...
        try {
            $value = Zend_Locale_Format::getTime('13:14:55', ['date_format' => 'nocontent']);
            $this->fail("exception expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
        ...
        try {
            $value = Zend_Locale_Format::getTime('13:14:55', ['date_format' => 'ZZZZ']);
            $this->fail("exception expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
    ...
    public function testSetOption()
    {
        ...
        try {
            $this->assertTrue(Zend_Locale_Format::setOptions(['format_type' => 'xxx']));
            $this->fail("exception expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
        try {
            $this->assertTrue(Zend_Locale_Format::setOptions(['myformat' => 'xxx']));
            $this->fail("exception expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
        ...
        try {
            $this->assertFalse(Zend_Locale_Format::setOptions(['number_format' => ['x' => 'x']]));
            $this->fail("exception expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
        ...
        try {
            $this->assertFalse(Zend_Locale_Format::setOptions(['date_format' => ['x' => 'x']]));
            $this->fail("exception expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
        try {
            $this->assertFalse(is_array(Zend_Locale_Format::setOptions(['fix_date' => 'no'])));
            $this->fail("exception expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }

        $format = Zend_Locale_Format::setOptions(['locale' => Zend_Locale_Format::STANDARD]);
        $locale = new Zend_Locale();
        $this->assertEquals($locale->toString(), $format['locale']);

        try {
            $this->assertFalse(is_array(Zend_Locale_Format::setOptions(['locale' => 'nolocale'])));
            $this->fail("exception expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
        try {
            $this->assertFalse(is_array(Zend_Locale_Format::setOptions(['precision' => 50])));
            $this->fail("exception expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
        ...
        try {
            $result = ['date_format' => 'MMM d, y', 'locale' => 'en_US', 'month' => '7',
                    'day' => '4', 'year' => '2007'];
            Zend_Locale_Format::setOptions(['format_type' => 'iso', 'date_format' => 'MMM d, y', 'locale' => 'en_US']); // test setUp
        } catch (Zend_Locale_Exception $e) {
            $this->fail("exception expected");
        }
        try {
        ...
        try {
            ...
            $this->assertSame($result, Zend_Locale_Format::getDate('July 4, 2007', ['locale' => 'en_US']));
        } catch (Zend_Locale_Exception $e) {
            $this->fail("exception expected");
        }
        try {
            // sets a new global date format
            Zend_Locale_Format::setOptions(['date_format' => 'M-d-y']);
        } catch (Zend_Locale_Exception $e) {
            $this->fail("exception expected");
        }
        try {
        ...
        try {
            ...
            $expect = Zend_Locale_Format::getDate('July 4, 2007', ['locale' => Zend_Locale_Format::STANDARD]);
    ...
    public function testToFloatSetlocale()
    {
        ...
        try {
            ...
            $params_fr = ['precision' => 2, 'locale' => $locale_fr];
            $params_en = ['precision' => 2, 'locale' => $locale_en];
            $myFloat = 1234.5;
    ...
    public function testgetDateTime()
    {
        ...
        $this->assertTrue(is_array(Zend_Locale_Format::getDateTime('10.11.2006 13:14:55', ['date_format' => 'dd.MM.yyyy HH:mm:ss'])));
        $options = ['date_format' => 'dd.MM.yy h:mm:ss a', 'locale' => 'en'];
        ...
        try {
            $value = Zend_Locale_Format::getDateTime('15.10.09 13:14:55', ['date_format' => 'nocontent']);
            $this->fail("exception expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
        ...
        try {
            $value = Zend_Locale_Format::getDateTime('15.10.09 13:14:55', ['date_format' => 'ZZZZ']);
            $this->fail("exception expected");
        } catch (Zend_Locale_Exception $e) {
            // success
        }
    ...
    public function testCheckDateFormatDoesNotEmitNoticeWhenNoOptionsAreNotProvided()
    {
        ...
        try {
            ...
            $checkDateFormat = Zend_Locale_Format::checkDateFormat('2011-10-21', []);
