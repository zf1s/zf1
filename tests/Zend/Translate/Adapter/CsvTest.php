...
class Zend_Translate_Adapter_CsvTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $adapter = new Zend_Translate_Adapter_Csv(__DIR__ . '/_files/translation_en.csv');
        ...
        $adapter = new Zend_Translate_Adapter_Csv(__DIR__ . '/_files/failed.csv', 'en');
    ...
    public function testOptionLocaleDirectory()
    {
        ...
        $adapter = new Zend_Translate_Adapter_Csv(__DIR__ . '/_files/testcsv', 'de_AT', array('scan' => Zend_Translate::LOCALE_DIRECTORY));
    ...
    {
        // require_once 'Zend/Translate.php';
        $adapter = new Zend_Translate_Adapter_Csv(__DIR__ . '/_files/testcsv', 'de_DE', array('scan' => Zend_Translate::LOCALE_FILENAME));
    ...
    {
        $adapter = new Zend_Translate_Adapter_Csv(__DIR__ . '/_files/translation_otherdelimiter.csv', 'en', array('delimiter' => ','));
        $this->assertEquals('Message 1 (en)', $adapter->translate('Message 1'));
        $this->assertEquals('Message 4 (en)', $adapter->translate('Message 4,'));
    ...
    {
        $adapter = new Zend_Translate_Adapter_Csv(__DIR__ . '/_files/translation_specialchars.csv', 'en');
        $this->assertEquals('Message 1 (en)', $adapter->translate('Message 1'));
        $this->assertEquals('Message 1 (en)', $adapter->_('Message 1'));
