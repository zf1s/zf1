...
class Zend_Translate_Adapter_TbxTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testLoadTranslationData()
    {
        ...
        $adapter->addTranslation(dirname(__FILE__) . '/_files/translation_en2.tbx', 'de', ['clear' => true]);
    ...
    public function testOptionLocaleDirectory()
    {
        ...
        $adapter = new Zend_Translate_Adapter_Tbx(dirname(__FILE__) . '/_files/testtbx', 'de', ['scan' => Zend_Translate::LOCALE_DIRECTORY]);
        $this->assertEquals(['en' => 'en', 'fr' => 'fr', 'de' => 'de'], $adapter->getList());
        $this->assertEquals('Nachricht 1', $adapter->translate('Message 1'));
    }
    ...
    {
        // require_once 'Zend/Translate.php';
        $adapter = new Zend_Translate_Adapter_Tbx(dirname(__FILE__) . '/_files/testtbx', 'de', ['scan' => Zend_Translate::LOCALE_FILENAME]);
        $this->assertEquals(['en' => 'en', 'fr' => 'fr', 'de' => 'de'], $adapter->getList());
        $this->assertEquals('Nachricht 1', $adapter->translate('Message 1'));
    }
