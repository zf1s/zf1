...
class Zend_Translate_Adapter_XliffTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testOptionLocaleDirectory()
    {
        ...
        $adapter = new Zend_Translate_Adapter_Xliff(dirname(__FILE__) . '/_files/testxliff', 'de', ['scan' => Zend_Translate::LOCALE_DIRECTORY]);
    ...
    {
        // require_once 'Zend/Translate.php';
        $adapter = new Zend_Translate_Adapter_Xliff(dirname(__FILE__) . '/_files/testxliff', 'de', ['scan' => Zend_Translate::LOCALE_FILENAME]);
        $this->assertEquals(['de' => 'de', 'en' => 'en', 'fr' => 'fr'], $adapter->getList());
        $this->assertEquals('Nachricht 1', $adapter->translate('Message 1'));
    }
    ...
    {
        $adapter = new Zend_Translate_Adapter_Xliff(dirname(__FILE__) . '/_files/translation_en3.xliff', 'en', ['useId' => false]);
        $this->assertEquals('Message 1 (en)', $adapter->translate('Message 1'));
        $this->assertEquals('Message 1 (en)', $adapter->_('Message 1'));
